...
const states ={
    ...
    handleInput(input){
        ...
        } else if (input.includes('Enter')/*|| input.includes('swipe down')*/){this.game.player.setState(states.ROLLING,2)}
        }
    }
...
handleInput(input){
    if (this.game.player.vy > this.game.player.gravety){
...
handleInput(input){
    this.game.particles.unshift(new Fire(this.game,this.game.player.x+this.game.player.width/16,this.game.player.y+this.game.player.height/32))


    if (!input.includes('Enter') && this.game.player.onGround()){
        this.game.energy=this.game.energy-1
        this.game.player.setState(states.RUNNING,1,);
    }
